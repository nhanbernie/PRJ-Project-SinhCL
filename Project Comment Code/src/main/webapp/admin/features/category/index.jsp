      ...
      <form id="quickForm">
        <div class="card-body">
          <div class="form-group" style="display: none">
            ...
            <input type="text" name="id" class="form-control" id="inpCategoryId">
          </div>
          <div class="form-group">
            <label for="name">Name</label> 
            <input type="text" name="name" class="form-control" id="inpCategoryName" placeholder="Enter name">
          </div>
          <div class="form-group">
        ...
        <div class="card-footer">
          <button type="button" class="btn btn-primary btn-sm" onclick="swicthViewCategory(true)">Cancel</button>
...
<script src="${pageContext.request.contextPath}/admin/features/category/index.js"></script>